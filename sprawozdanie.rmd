...
header-includes:
  \usepackage{xcolor}
  \definecolor{lightyellow}{rgb}{30.0, 0.0, 0.8}
...
Oba algorytmy można stosować w zadanej dziedzinie, różnią się jednak podejściem. \textcolor{lightyellow}{PRS} polega na losowym próbkowaniu całej przestrzeni, natomiast \textcolor{green}{MS} wykorzystuje optymalizację lokalną, aby dokładniej zbadać okolice losowo wybranych punktów startowych.
