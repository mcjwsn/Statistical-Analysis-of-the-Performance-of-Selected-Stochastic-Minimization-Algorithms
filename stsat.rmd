...
\textcolor{blue}{Funckaj Schwefela} jest złożoną funkcją, posiadającą wiele minimów lokalnych.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{schwef2.png}
    \caption*{Wzór \textcolor{blue}{funkcji Schwefela}}
\end{figure}
...
Minimum globalne $f(\mathbf{x^*}) = 0, \quad \text{dla } \mathbf{x^*} = (420.9687, \dots, 420.9687)$

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{schwefel1.png}
    \caption*{Reprezentacja funckji w przestrzeni dwuwymiarowej}
\end{figure}
...
\textcolor{purple}{Funkcja Griewanka} ma wiele szeroko rozpowszechnionych minimów lokalnych, które są regularnie dystrybuowane.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{griewank2.png}
    \caption*{Wzór \textcolor{purple}{funkcji Griewanka}}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{griewank1.png}
    \caption*{Wizualizacja\textcolor{purple}{funkcji Griewanka} }
\end{figure}
...
-   średnia: `r mean(G2MS)`
-   Wartość najmniejsza: `r min(G2MS)`
-   Wartość największa: `r max(G2MS)`
-   Mediana: `r median(G2MS)`
-   Dolny kwartyl: `r quantile(G2MS, 0.25)`
-   Górny kwartyl: `r quantile(G2MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(G2PRS)`

-   Wartość najmniejsza: `r min(G2PRS)`

-   Wartość największa: `r max(G2PRS)`

-   Mediana: `r median(G2PRS)`

-   Dolny kwartyl: `r quantile(G2PRS, 0.25)`

-   Górny kwartyl: `r quantile(G2PRS, 0.75)`

## \textcolor{purple}{Funkcja Griewanka 10D}

### \textcolor{green}{MS}

-   średnia: `r mean(G10MS)`
-   Wartość najmniejsza: `r min(G10MS)`
-   Wartość największa: `r max(G10MS)`
-   Mediana: `r median(G10MS)`
-   Dolny kwartyl: `r quantile(G10MS, 0.25)`
-   Górny kwartyl: `r quantile(G10MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(G10PRS)`

-   Wartość najmniejsza: `r min(G10PRS)`

-   Wartość największa: `r max(G10PRS)`

-   Mediana: `r median(G10PRS)`

-   Dolny kwartyl: `r quantile(G10PRS, 0.25)`

-   Górny kwartyl: `r quantile(G10PRS, 0.75)`

## \textcolor{purple}{Funkcja Griewanka 20D}

### \textcolor{green}{MS}

-   średnia: `r mean(G20MS)`
-   Wartość najmniejsza: `r min(G20MS)`
-   Wartość największa: `r max(G20MS)`
-   Mediana: `r median(G20MS)`
-   Dolny kwartyl: `r quantile(G20MS, 0.25)`
-   Górny kwartyl: `r quantile(G20MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(G20PRS)`

-   Wartość najmniejsza: `r min(G20PRS)`

-   Wartość największa: `r max(G20PRS)`

-   Mediana: `r median(G20PRS)`

-   Dolny kwartyl: `r quantile(G20PRS, 0.25)`

-   Górny kwartyl: `r quantile(G20PRS, 0.75)`
...
-   średnia: `r mean(S2MS)`
-   Wartość najmniejsza: `r min(S2MS)`
-   Wartość największa: `r max(S2MS)`
-   Mediana: `r median(S2MS)`
-   Dolny kwartyl: `r quantile(S2MS, 0.25)`
-   Górny kwartyl: `r quantile(S2MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(S2PRS)`

-   Wartość najmniejsza: `r min(S2PRS)`

-   Wartość największa: `r max(S2PRS)`

-   Mediana: `r median(S2PRS)`

-   Dolny kwartyl: `r quantile(S2PRS, 0.25)`

-   Górny kwartyl: `r quantile(S2PRS, 0.75)`

## \textcolor{blue}{Funkcja Schwefela 10D}

### \textcolor{green}{MS}

-   średnia: `r mean(S10MS)`
-   Wartość najmniejsza: `r min(S10MS)`
-   Wartość największa: `r max(S10MS)`
-   Mediana: `r median(S10MS)`
-   Dolny kwartyl: `r quantile(S10MS, 0.25)`
-   Górny kwartyl: `r quantile(S10MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(S10PRS)`

-   Wartość najmniejsza: `r min(S10PRS)`

-   Wartość największa: `r max(S10PRS)`

-   Mediana: `r median(S10PRS)`

-   Dolny kwartyl: `r quantile(S10PRS, 0.25)`

-   Górny kwartyl: `r quantile(S10PRS, 0.75)`

## \textcolor{blue}{Funkcja Schwefela 20D}

### \textcolor{green}{MS}

-   średnia: `r mean(S20MS)`
-   Wartość najmniejsza: `r min(S20MS)`
-   Wartość największa: `r max(S20MS)`
-   Mediana: `r median(S20MS)`
-   Dolny kwartyl: `r quantile(S20MS, 0.25)`
-   Górny kwartyl: `r quantile(S20MS, 0.75)`

### \textcolor{lightyellow}{PRS}

-   średnia: `r mean(S20PRS)`

-   Wartość najmniejsza: `r min(S20PRS)`

-   Wartość największa: `r max(S20PRS)`

-   Mediana: `r median(S20PRS)`

-   Dolny kwartyl: `r quantile(S20PRS, 0.25)`

-   Górny kwartyl: `r quantile(S20PRS, 0.75)`
...
hist(G2MS, main="", 
     ...
     ylim = c(0,70), xlim = c(0,5), col=rgb(0.75,0.1,0.3),
...
Wraz ze wzrostem liczby wymiarów, różnica między algorytmami staje się coraz bardziej wyraźna. Przewaga \textcolor{green}{MS} nad \textcolor{lightyellow}{PRS} rośnie wykładniczo wraz z wymiarowością.

### Porównanie funkcji:

\textcolor{blue}{Funkcja Schwefela} wykazuje większe różnice między algorytmami niż funkcja \textcolor{purple}{Griewanka}. Dla \textcolor{purple}{funkcji Griewanka} w 2D nie zaobserwowano istotnej różnicy między algorytmami.

### Efektywność algorytmów:

\textcolor{green}{MS} konsekwentnie osiąga lepsze wyniki niż \textcolor{lightyellow}{PRS} dla wszystkich przypadków (z wyjątkiem G2D). Różnice są szczególnie widoczne w wyższych wymiarach. \textcolor{green}{MS} wydaje się być znacznie bardziej odpowiedni dla problemów wielowymiarowych.

### Rekomendacje:

Dla problemów 2D: można stosować oba algorytmy (szczególnie dla \textcolor{purple}{funkcji Griewanka}). Dla problemów wielowymiarowych: zdecydowanie zalecane jest użycie \textcolor{green}{MS} W przypadku \textcolor{blue}{funkcji Schwefela}: \textcolor{green}{MS} powinien być preferowanym wyborem niezależnie od wymiarowości.
